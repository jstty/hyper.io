...
ServiceManager.prototype._setupRoutes = function (service) {
    return when.reduce(service.routes, (function (notUsed, route) {
        ...
        //}
                ...
                this._serviceMiddlewareManager.setup(service, controller, route);
...
ServiceManager.prototype._getTemplateFunc = function (service, route, routeStr, templateMiddleware, templateDefaultMW) {
    var templateData = "";
...
ServiceManager.prototype._genPromiseHandle = function (generator, result) {
        ...
        viewPromise = viewPromise.then((function (templateFunc) {
            ...
            (function (req, res, next) {
                ...
                resolverPromise.then((function () {
                    ...
                    var generator = this._injectionDependency(module, service, controller, cFunc);

                    var promise = null;
                    if (cFunc && cFunc.constructor && cFunc.constructor.name === 'GeneratorFunction') {
                        try {
                            promise = this._genPromiseHandle(generator, generator.next());
                        } catch (ex) {
