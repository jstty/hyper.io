...
Middleware.prototype.use = function (MiddlewareGroup, MiddlewareName, option) {
  if (_.isString(option) && option === 'default') {
    ...
    // OR
    // not name the same
    if (!defaultMiddleware || defaultMiddleware && defaultMiddleware.name !== MiddlewareName) {
...
Middleware.prototype._getMiddleware = function (MiddlewareGroup, MiddlewareName) {
  if (this.middleware.hasOwnProperty(MiddlewareGroup) && this.middleware[MiddlewareGroup].hasOwnProperty(MiddlewareName)) {
...
Middleware.prototype._setMiddleware = function (MiddlewareClass) {
  ...
  if (middlewareInstance.getInfo && _.isFunction(middlewareInstance.getInfo)) {
