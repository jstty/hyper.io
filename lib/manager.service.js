 ...
 * Constructor
 * --------------------------------------------------- */
function ServiceManager(config, servicesConfig, middleware, hyperCore) {
...
// load all services
ServiceManager.prototype.load = function(opts) {
    var appPromise = this._httpFramework.load(opts);
