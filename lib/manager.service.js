...
// ------------------------------------------------
    ...
    _.forEach(this._servicesConfig.services, function(service, key) {
        ...
        this._services[key].resources  = {};

        // add service to service router
        this._serviceRouter.add(this._services[key].name);
        ...
        if( this._services[key].module ) {
            ...
            var module = {
                '$resource': ['value', this._getResourceHandler(this._services[key]) ],
                '$logger':   ['value', util.logger(this._services[key].name) ]
            };
            ...
            dim.add(this._services[key].resources); // just service resource
            dim.setParent(this._services[key]);
            this._services[key].instance = dim.inject();
