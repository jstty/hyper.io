...
// ------------------------------------------------
    ...
    _.forEach(this._servicesConfig.services, function(service, key) {
        ...
        if( this._services[key].module ) {
            ...
            var InjectedModule = this._injectionDependency(module, this._services[key], this._services[key]);
        ...
        try {
            ...
            if (fs.existsSync(staticContent)) {
                ...
                if (stats.isDirectory()) {
                    ...
                    this._httpFramework.addMethodFunction('get', null, route, function(req, res){
