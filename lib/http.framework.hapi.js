...
HttpFramework_Hapi.prototype.getName = function() {
    return 'hapi';
};

HttpFramework_Hapi.prototype.addMethodFunction = function(method, plugins, routeStr, func) {
    method = method.toUpperCase();
...
HttpFramework_Hapi.prototype.buildInputs = function($rawRequest) {
    // POST - req.body
    // GET  - req.query
    // GET  - req.hash
    // URL  - req.params
