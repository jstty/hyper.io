...
function Hyper(options) {
    ...
    // make sure serviceManager options exist
    if(!this._options.serviceManager) {
        this._options.serviceManager = {};
    }
...
Hyper.prototype.load = function(servicesConfig) {
    ...
    // service manager
    this._serviceManager = new ServiceManager(this._config, this._servicesConfig, this._middleware, this);
    this._serviceManager.setHttpFramework(this._httpFramework);

    return this._serviceManager.load(this._options.serviceManager)
        .then(function(){
            return this;
        }.bind(this));
};
