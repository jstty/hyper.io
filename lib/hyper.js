...
function Hyper(options) {
    ...
    // ------------------------------
    // normalize options
    // make sure object configs exist
    if(!this._options.hasOwnProperty('hyper'))          { this._options.hyper = {}; }
    if(!this._options.hasOwnProperty('httpFramework'))  { this._options.httpFramework = {}; }
    if(!this._options.hasOwnProperty('serviceManager')) { this._options.serviceManager = {}; }

    if( this._options.env &&
        !this._options.serviceManager.hasOwnProperty('env')) {
        this._options.serviceManager.env = this._options.env;
    }
    if( this._options.env &&
        !this._options.httpFramework.hasOwnProperty('env')) {
        this._options.httpFramework.env = this._options.env;
    }
    if( this._options.hasOwnProperty('port') &&
        !this._options.httpFramework.hasOwnProperty('port')) {
        this._options.httpFramework.port = this._options.port;
    }
    if(this._options.hasOwnProperty('displayDebuggerInfo')) {
        this._options.hyper.displayDebuggerInfo = this._options.displayDebuggerInfo;
        this._options.httpFramework.displayDebuggerInfo = this._options.displayDebuggerInfo;
        this._options.serviceManager.displayDebuggerInfo = this._options.displayDebuggerInfo;
    }
    if(this._options.silent) {
        this._options.httpFramework.silent = true;
        this._options.serviceManager.silent = true;
        logger.setEnv('prod');
    }
    // ------------------------------
...
Hyper.prototype.load = function(servicesConfig) {
    ...
    // make sure serviceManager/httpFramework config exist
    if(!this._config.hasOwnProperty('serviceManager')) { this._config.serviceManager = {};}
    if(!this._config.hasOwnProperty('httpFramework'))  { this._config.httpFramework = {}; }
    ...
    // service manager
    this._serviceManager = new ServiceManager(this._config.serviceManager, this._servicesConfig, this._middleware, this);
...
Hyper.prototype.getHttpFramework = function() {
