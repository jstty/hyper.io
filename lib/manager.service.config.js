    ...
    _createClass(ServiceManagerConfig, [{
        ...
        value: function _normalize() {
            ...
            if (_lodash2['default'].isArray(config)) {
                ...
                // has sub services
                _lodash2['default'].forEach(config.services, (function (service) {
        ...
        value: function _normalizeService(service) {
            ...
            if (!service.hasOwnProperty('routes')) {
                try {
                    ...
                    var fileSearchPath = _path2['default'].resolve(process.cwd(), service.directory.service) + _path2['default'].sep + '**' + _path2['default'].sep + appName + '.routes.js';
